        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-12">
          ...
          >
            ...
            <div className="absolute inset-0 z-10 flex flex-col justify-center items-center px-6 md:px-8
                            ...
                            md:group-hover:translate-y-0 md:group-hover:opacity-100
                            pointer-events-none">
              <h3 className="font-serif text-brand-gold text-2xl md:text-3xl mb-3 md:mb-5 drop-shadow-lg">Caramel & Cheese</h3>
              <p className="font-serif text-white text-sm md:text-base leading-relaxed text-center drop-shadow-lg font-medium">
                Indulgent caramel meets sharp, bold cheddar in one bag. Sweet and savory, side by side. This one is made for people who can never pick just one.
              </p>
            </div>
